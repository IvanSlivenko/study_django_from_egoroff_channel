...
urlpatterns = [
    path('', views.index, name='horoscope-index'),#horoscope
    path('menu', views.index_render, name='horoscope-index_render'),#horoscope/menu
    path('study', views.index_study_render, name='horoscope-index_study_render'),#horoscope/study
